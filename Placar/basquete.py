...
current_quarter_display = 1  # Set atual, começa no 1
...
#########################################################################################################
    ...
    def update_score():
        ...
        labelFaltas1.config(text=str(setTeam1))
        labelFaltas2.config(text=str(setTeam2))
        #.config(text=str(subsTeam1))
    ...
    def next_set():
        global scoreTeam1, scoreTeam2, scoreTeam1_control, scoreTeam2_control, current_set, current_quarter_display
    ...
    def prev_set():
        global scoreTeam1, scoreTeam2, current_set, current_quarter_display
        # Armazenar o placar do set atual
        store_set_score()
    ...
    def set_current_set(set_number):
        global current_quarter_display
        current_quarter_display = set_number
    ...
    # Labels dos sets
    labelwordFaltas1 = tk.Label(root, text=f"Faltas:", font=("Montserrat SemiBold", 60), bg=colorBackground, fg=colorFont)
    labelFaltas1 = tk.Label(root, text=f"{setTeam1}", font=("Montserrat SemiBold", 60), bg=colorBackground, fg=colorFont)
    labelwordFaltas2 = tk.Label(root, text=f"Faltas:", font=("Montserrat SemiBold", 60), bg=colorBackground, fg=colorFont)
    labelFaltas2 = tk.Label(root, text=f"{setTeam2}", font=("Montserrat SemiBold", 60), bg=colorBackground, fg=colorFont)


    # Labels do placar
    labelTeam1.place(relx=0.05, rely=0.025, relwidth=0.3, relheight=0.1, anchor="nw")
    labelScore1.place(relx=0.39, rely=0.4, relwidth=0.18, relheight=0.2, anchor="center")
    labelwordFaltas1.place(relx=0.05, rely=0.59, relwidth=0.18, relheight=0.09, anchor="nw")
    labelFaltas1.place(relx=0.27, rely=0.59, relwidth=0.04, relheight=0.09, anchor="ne")

    labelCross.place(relx=0.5, rely=0.4, relwidth=0.05, relheight=0.2, anchor="center")

    labelTeam2.place(relx=0.95, rely=0.025, relwidth=0.3, relheight=0.1, anchor="ne")
    labelScore2.place(relx=0.61, rely=0.4, relwidth=0.18, relheight=0.2, anchor="center")
    labelwordFaltas2.place(relx=0.73, rely=0.59, relwidth=0.18, relheight=0.09, anchor="nw")
    labelFaltas2.place(relx=0.95, rely=0.59, relwidth=0.04, relheight=0.09, anchor="ne")

    # Label do cronômetro
    timer_label = tk.Label(root, text="00:00:00", font=("Montserrat SemiBold", 70), bg=colorBackground, fg=colorFont)
    ...
    separator_lateral_esquerda.place(relx=0.35, rely=0, relheight=0.15)
    separator_lateral_direita = tk.Frame(root, bg="black", width=4)  # Defina a altura como 2 para uma linha fina
    separator_lateral_direita.place(relx=0.65, rely=0, relheight=0.15)
    ...
    for i in range(4):
        ...
        quarter_label = tk.Label(root, text=f"QUARTER {i + 1}", font=("Montserrat SemiBold", 40), bg=colorBackground, fg=colorFont)
        score_label = tk.Label(root, text="0 x 0", font=("Montserrat SemiBold", 40), bg=colorBackground, fg=colorFont)
        quarter_label.place(relx=0.05 + i * 0.225, rely=0.72, relwidth=0.22, relheight=0.08)
        score_label.place(relx=0.05 + i * 0.225, rely=0.81, relwidth=0.22, relheight=0.08)
        set_score_labels.append((quarter_label, score_label))

    # Adicionar o label do set atual na janela principal
    labelCurrentQuarter = tk.Label(root, text=f"Quarter atual: {current_quarter_display}", font=("Montserrat SemiBold", 60), bg=colorBackground, fg=colorFont)
    labelCurrentQuarter.place(relx=0.5, rely=0.59, relwidth=0.45, relheight=0.1, anchor="n")  # Posicionamento centralizado abaixo do placar    
    ...
    # Posicionar os labels das substituições ao lado dos nomes das equipes
    #labelwordTime1.place(relx=0.05, rely=0.77, relwidth=0.135, relheight=0.05, anchor="nw")
    #labelTime1.place(relx=0.24, rely=0.77, relwidth=0.03, relheight=0.05, anchor="ne")
    #labelwordTime2.place(relx=0.76, rely=0.77, relwidth=0.135, relheight=0.05, anchor="nw")
    #labelTime2.place(relx=0.95, rely=0.77, relwidth=0.03, relheight=0.05, anchor="ne")
...
##########################################################################################################
    ...
    def reset_sets():
        global setTeam1, setTeam2, scoreTeam1, scoreTeam2, current_set, current_quarter_display
        setTeam1 = 0
        setTeam2 = 0
        scoreTeam1 = 0
        scoreTeam2 = 0
    ...
    buttonTeam1Up1 = tk.Button(controlWindow, text="Time1 +1", font=("Montserrat SemiBold", 10), command=increase1Team1)
    buttonTeam1Up2 = tk.Button(controlWindow, text="Time1 +2", font=("Montserrat SemiBold", 10), command=increase2Team1)
    buttonTeam1Up3 = tk.Button(controlWindow, text="Time1 +3", font=("Montserrat SemiBold", 10), command=increase3Team1)
    buttonTeam1Down = tk.Button(controlWindow, text="Time1 -1", font=("Montserrat SemiBold", 10), command=decreaseTeam1)

    buttonTeam2Up1 = tk.Button(controlWindow, text="Time2 +1", font=("Montserrat SemiBold", 10), command=increase1Team2)
    buttonTeam2Up2 = tk.Button(controlWindow, text="Time2 +2", font=("Montserrat SemiBold", 10), command=increase2Team2)
    buttonTeam2Up3 = tk.Button(controlWindow, text="Time2 +3", font=("Montserrat SemiBold", 10), command=increase3Team2)
    buttonTeam2Down = tk.Button(controlWindow, text="Time2 -1", font=("Montserrat SemiBold", 10), command=decreaseTeam2)

    # Botões para controle dos sets
    buttonFaltas1Up = tk.Button(controlWindow, text="Time 1 +1 Falta", command=increaseFaltas1)
    buttonFaltas1Down = tk.Button(controlWindow, text="Time 1 -1 Falta", command=decreaseFaltas1)
    buttonFaltas2Up = tk.Button(controlWindow, text="Time 2 +1 Falta", command=increaseSet2)
    buttonFaltas2Down = tk.Button(controlWindow, text="Time 2 -1 Falta", command=decreaseFaltas2)
    ...
    buttonNextSet = tk.Button(controlWindow, text="Próximo \nQuarter", font=("Montserrat SemiBold", 18), command=next_set)
    buttonPrevSet = tk.Button(controlWindow, text="Quarter \nAnterior", font=("Montserrat SemiBold", 18), command=prev_set)
    buttonResetSets = tk.Button(controlWindow, text="Zerar Quarters", font=("Montserrat SemiBold", 10), command=reset_sets)
    ...
    labelScore_control = Label(controlWindow, text=str(scoreTeam1_control) + " x " + str(scoreTeam2_control), font=("Montserrat SemiBold", 80), bg=colorBackground, fg=colorFont)
    ...
    timer_label_control = tk.Label(controlWindow, text="10:00:00", font=("Montserrat SemiBold", 50), bg="white", fg="black")
    ...
    buttonTeam1Up1.place(relx=0.15, rely=0.4, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonTeam1Up2.place(relx=0.15, rely=0.45, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonTeam1Up3.place(relx=0.15, rely=0.50, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonTeam1Down.place(relx=0.15, rely=0.4, relwidth=0.1, relheight=0.05, anchor="ne")

    buttonTeam2Up1.place(relx=0.85, rely=0.4, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonTeam2Up2.place(relx=0.85, rely=0.45, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonTeam2Up3.place(relx=0.85, rely=0.50, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonTeam2Down.place(relx=0.85, rely=0.4, relwidth=0.1, relheight=0.05, anchor="ne")

    # Posicionar os botões dos sets
    buttonFaltas1Up.place(relx=0.15, rely=0.65, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonFaltas2Up.place(relx=0.85, rely=0.65, relwidth=0.1, relheight=0.05, anchor="nw")
    buttonFaltas1Down.place(relx=0.15, rely=0.65, relwidth=0.1, relheight=0.05, anchor="ne")
    buttonFaltas2Down.place(relx=0.85, rely=0.65, relwidth=0.1, relheight=0.05, anchor="ne")
