...
#########################################################################################################
    ...
    serve_icon = PhotoImage(file="C:/Users/Vinic/OneDrive/Documentos/Placar/Volei/Imagens/white_ball.png")
    ...
    labelTeam1 = tk.Label(root, text="Equipe 1", font=("Montserrat Bold", 40), relief = "groove", bg=colorBackground, fg=colorFont)
...
##########################################################################################################
    ...
    for i in range(4):
        set_label= tk.Label(controlWindow, text=f"SET {i + 1}", font=("Montserrat SemiBold", 30), relief = "groove", bg=colorBackground, fg=colorFont)
        score_label = tk.Label(controlWindow, text=str(scoreTeam1) + " x " + str(scoreTeam2), font=("Montserrat SemiBold", 25), relief = "groove", bg=colorBackground, fg=colorFont)
    ...
    scoreTeam1ControlWindow = tk.Label(controlWindow, text=f"Pontos: {scoreTeam1}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    scoreTeam1ControlWindow.place(relx=0.15, rely=0.4, relwidth=0.2, relheight=0.05, anchor="n")
    scoreTeam2ControlWindow = tk.Label(controlWindow, text=f"Pontos: {scoreTeam2}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    ...
    setTeam1ControlWindow = tk.Label(controlWindow, text=f"Sets: {setTeam1}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    setTeam1ControlWindow.place(relx=0.075, rely=0.45, relwidth=0.15, relheight=0.05, anchor="nw")
    setTeam2ControlWindow = tk.Label(controlWindow, text=f"Sets: {setTeam2}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    ...
    labelSubs1ControlWindow = tk.Label(controlWindow, text=f"Substituições: {subsTeam1}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    labelSubs1ControlWindow.place(relx=0.15, rely=0.55, relwidth=0.15, relheight=0.05, anchor="n")
    labelSubs2ControlWindow = tk.Label(controlWindow, text=f"Substituições: {subsTeam2}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    ...
    timeTeam1ControlWindow = tk.Label(controlWindow, text=f"Tempos: {timeTeam1}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    timeTeam1ControlWindow.place(relx=0.15, rely=0.6, relwidth=0.15, relheight=0.05, anchor="n") 
    timeTeam2ControlWindow = tk.Label(controlWindow, text=f"Tempos: {timeTeam2}", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    ...
    challengeTeam1ControlWindow = tk.Label(controlWindow, text=f"Desafios: {challengeTeam1}/2", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    challengeTeam1ControlWindow.place(relx=0.15, rely=0.50, relwidth=0.15, relheight=0.05, anchor="n") 
    challengeTeam2ControlWindow = tk.Label(controlWindow, text=f"Desafios: {challengeTeam2}/2", font=("Montserrat SemiBold", 20), relief = "groove", bg=colorBackground)
    ...
    title_label = tk.Label(controlWindow, text="Set atual", font=("Arial", 25), relief = "groove", bg="lightgray", fg="black")
    title_label.place(relx=0.5, rely=0.45, relwidth=0.4, relheight=0.05, anchor="n")  # Posiciona no topo centralizado

    labelCurrentSetControl = tk.Label(controlWindow, text=current_set_display, font=("Montserrat SemiBold", 40), relief = "groove", bg="white", fg="black")
    ...
    labelScore_control = Label(controlWindow, text=str(scoreTeam1) + " x " + str(scoreTeam2), font=("Montserrat SemiBold", 80), relief = "groove", bg=colorBackground, fg=colorFont)
    ...
    title_label = tk.Label(controlWindow, text="Cronômetro", font=("Arial", 25), relief = "groove", bg="lightgray", fg="black")
    ...
    timer_label_control = tk.Label(controlWindow, text="00:00", font=("Montserrat SemiBold", 50), relief = "groove", bg="white", fg="black")
